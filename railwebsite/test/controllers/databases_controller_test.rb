...
class DatabasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create database" do
    assert_difference("Database.count") do
      post databases_url, params: { database: { email: @database.email, first_name: @database.first_name, last_name: @database.last_name, phone: @database.phone, twitter: @database.twitter } }
    end
  ...
  test "should update database" do
    patch database_url(@database), params: { database: { email: @database.email, first_name: @database.first_name, last_name: @database.last_name, phone: @database.phone, twitter: @database.twitter } }
